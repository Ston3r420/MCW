      ...
      <div className="container">
        <div className="card text-center" style={{ maxWidth: 400, margin: '0 auto', padding: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <a href={`${BACKEND_URL}/auth/twitch`} target="_top" rel="noopener noreferrer" className="btn btn-primary" style={{ fontSize: '1rem', padding: '0.8rem 1.5rem', width: '100%', justifyContent: 'center' }}>
              <TwitchIcon />
              Login with Twitch
            </a>
          </div>
